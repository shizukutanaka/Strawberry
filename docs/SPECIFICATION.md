...
2. work-verifier / reputation-scorer / feature-pricer / **escrow-service** の**配線**（マッチング・決済解放・出品価格）。← 次の山
3. **Provider reputation** / **Verification record** の永続化エンティティ追加（Escrow は実装済）。当面 JSON, 将来 Prisma。

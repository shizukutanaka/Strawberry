...
// 入力となる `utilSamples` は **admin が旧 `/escrow/:id/verify`（2026-09 第8回点検で
// 削除）のリクエストボディで手渡す**経路しか無く、実レンタルからは一度も呼ばれて
// いなかった。つまり「借りた GPU が本当に計算したか」を検証する仕組みは、部品は
// あっても稼働していなかった。本モジュールはハートビートに相乗りしてサンプルを
// 集め、その穴を埋める。
//

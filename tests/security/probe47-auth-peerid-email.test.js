...
// 47c-1: (removed 2026-09 — the peerId feature it guarded no longer exists)
...
// ─── 47c-1: (削除) peerid admin/all の email 露出 ─────────────────────────
// peerId 機能ごと削除したためこの検査は不要になった（2026-09）。PeerID は libp2p 上の
// 身元で、それを識別する P2P レイヤは既に無く、149 人のうち設定した者もゼロだった。
// PII 相関のリスクは、相関させる値そのものを持たないことで消えている。
